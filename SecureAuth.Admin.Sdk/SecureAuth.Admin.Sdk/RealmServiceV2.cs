...
{
    public class RealmServiceV2 : IRealmServiceV2
    {
        private readonly ApiClient _apiClient;

        protected internal RealmServiceV2(ApiClient apiClient)
        {
        ...
        public RealmResponse GetRealm(string realmId)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}", realmId);
        ...
        public BaseResponse UpdateOverview(OverviewRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/overview", request.RealmId);
        ...
        public BaseResponse UpdateDataMembership(DataMembershipRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/data/membership", request.RealmId);
        ...
        public BaseResponse UpdateDataProfile(DataProfileRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/data/profile", request.RealmId);
        ...
        public BaseResponse UpdateDataGlobalAux(DataGlobalAuxRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/data/globalaux", request.RealmId);
        ...
        public BaseResponse UpdateWorkflow(WorkflowRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/workflow", request.RealmId);
        ...
        /// <returns>BaseResponse</returns>
        public BaseResponse UpdateAdaptiveAuth(AdaptiveAuthRequestV2 request)
        {
            if (request == null)
            {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/adaptiveauth", request.RealmId);
        ...
        public BaseResponse UpdateMultifactor(MultifactorRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/multifactor", request.RealmId);
        ...
        public BaseResponse UpdatePostAuth(PostAuthRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/postauth", request.RealmId);
        ...
        public BaseResponse UpdateLogSettings(LogSettingRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/logsettings", request.RealmId);
        ...
        public BaseResponse UpdateApi(ApiSettingRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/apisettings", request.RealmId);
        ...
        {
            string endpoint = string.Format("/api/v2/realms/{0}/apigeneratecredentials", realmId);
        ...
        public PhoneCarrierResponse GetPhoneCarriers(string realmId)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/phonecarriers", realmId);
        ...
        public BaseResponse UploadCompanyLogo(OverviewRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/overview/companylogo", request.RealmId);
        ...
        public BaseResponse UploadApplicationLogo(OverviewRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/overview/applicationlogo", request.RealmId);
        ...
        public BaseResponse UploadEmailLogo(OverviewRequest request)
        {
            ...
            endpoint = string.Format("/api/v2/realms/{0}/overview/emaillogo", request.RealmId);

            return this._apiClient.Post<BaseResponse>(endpoint, request);
        }

        /// <summary>
        /// Tests the connection using the connection settings
        /// provided in the requests
        /// </summary>
        /// <param name="UserRiskProviderRequest">UserRiskProviderRequest object with User Risk Provider conneciton settings</param>
        /// <returns>TestConnectionResponse</returns>
        public TestConnectionResponse TestUserRiskProviderConnection(UserRiskProviderRequest request)
        {
            if (request == null)
            {
                throw new ArgumentNullException("UserRiskProviderRequest", "Request cannot be empty.");
            }

            if (request.UserRiskProvider == null)
            {
                throw new ArgumentNullException("UserRiskProvider", "User Risk Provider cannot be empty.");
            }

            string endpoint;

            endpoint = "/api/v2/adaptiveauth/riskproviders/test";

            return this._apiClient.Post<TestConnectionResponse>(endpoint, request);
